import {
  ...
  effectScope as an,
  markRaw as on,
  resolveComponent as un,
} from "vue";
const cn = /\d/,
  ln = ["-", "_", "/", "."];
function dn(e = "") {
  if (!cn.test(e)) return e.toUpperCase() === e;
}
function fn(e, t) {
  const n = t != null ? t : ln,
    r = [];
...
const Da = "frontend.detail.page",
  qa = "frontend.navigation.page",
  Ma = "frontend.landing.page";
function La(e) {
  const { getConfigValue: t } = vn(e),
    n = v(() => ({
    ...
    a = v(() => {
      const f = {};
      return (
        s.value.url && (f.href = s.value.url),
        s.value.newTab &&
          ((f.target = "blank"), (f.rel = "noopener noreferrer")),
        f
      );
    }),
    o = "",
    c = v(() => {
      ...
      return {
        src:
          (d = (f = e.data) == null ? void 0 : f.media) == null
            ? void 0
            : d.url,
        alt:
          (h = (y = e.data) == null ? void 0 : y.media) == null
            ? void 0
            : h.fileName,
        srcset:
          ((S =
            (O = (w = e.data) == null ? void 0 : w.media) == null
              ? void 0
              : O.thumbnails) == null
            ? void 0
            : S.reduce(
...
function k() {
  ...
  if (!e) throw new Error("Shopware context is not available.");
  return {
    apiInstance: e.apiInstance,
  };
}
function Q(e, t) {
  const r = !!(t != null && t.context)
    ? T(Ie(t == null ? void 0 : t.context))
    : M(e, T());
  return L(e, r), t != null && t.replace && (r.value = Ie(t.replace)), r;
}
function gn(e) {
  const t = Q("category", { context: e });
  if (!t.value) throw new Error("Category context is not provided.");
  return {
    category: v(() => t.value),
  };
}
...
function Te() {
  ...
  for (var n = 0, r = arguments.length; n < r; n++) De(arguments[n], t);
  return e;
}
function Nn(e, t, n) {
  return (
...
var Rt = function (t, n, r) {
    ...
    var s;
    if (r) s = r(n);
    else if (z.isURLSearchParams(n)) s = n.toString();
    else {
      var a = [];
      z.forEach(n, function (g, f) {
        g === null ||
          typeof g > "u" ||
          (z.isArray(g) ? (f = f + "[]") : (g = [g]),
          z.forEach(g, function (y) {
            z.isDate(y)
              ? (y = y.toISOString())
              : z.isObject(y) && (y = JSON.stringify(y)),
              a.push(We(f) + "=" + We(y));
          }));
      }),
        (s = a.join("&"));
...
X.from = function (e, t, n, r, s, a) {
  ...
  return (
    xt.toFlatObject(e, o, function (g) {
      return g !== Error.prototype;
    }),
    X.call(o, e.message, t, n, r, s),
    (o.name = e.name),
    a && Object.assign(o, a),
    o
  );
...
function Wn(e, t) {
  ...
  function r(a) {
    return a === null
      ...
      : B.isDate(a)
      ? a.toISOString()
      : B.isArrayBuffer(a) || B.isTypedArray(a)
  ...
  function s(a, o) {
    if (B.isPlainObject(a) || B.isArray(a)) {
      ...
      n.push(a),
        B.forEach(a, function (g, f) {
          if (!B.isUndefined(g)) {
            var d = o ? o + "." + f : f,
              y;
            if (g && !o && typeof g == "object") {
              if (B.endsWith(f, "{}")) g = JSON.stringify(g);
...
function Vn() {
  ...
  var e = _;
  return (
    (he = e.isStandardBrowserEnv()
      ? (function () {
          return {
            write: function (r, s, a, o, c, g) {
              var f = [];
              f.push(r + "=" + encodeURIComponent(s)),
                e.isNumber(a) && f.push("expires=" + new Date(a).toGMTString()),
                e.isString(o) && f.push("path=" + o),
                e.isString(c) && f.push("domain=" + c),
                g === !0 && f.push("secure"),
...
`),
            function (f) {
              if (
                ((c = f.indexOf(":")),
                (a = e.trim(f.substr(0, c)).toLowerCase()),
                (o = e.trim(f.substr(c + 1))),
                a)
              ) {
                if (s[a] && t.indexOf(a) >= 0) return;
                a === "set-cookie"
                  ? (s[a] = (s[a] ? s[a] : []).concat([o]))
                  : (s[a] = s[a] ? s[a] + ", " + o : o);
              }
            }
          ),
    ...
    (ge = e.isStandardBrowserEnv()
      ? (function () {
          ...
          function a(o) {
            var c = o;
            return (
              n && (r.setAttribute("href", c), (c = r.href)),
    ...
    (we = function (h) {
      return new Promise(function (O, S) {
        var A = h.data,
          ...
          p;
        function u() {
          h.cancelToken && h.cancelToken.unsubscribe(p),
            h.signal && h.signal.removeEventListener("abort", p);
        }
        e.isFormData(A) && e.isStandardBrowserEnv() && delete m["Content-Type"];
        var l = new XMLHttpRequest();
        if (h.auth) {
          var C = h.auth.username || "",
            I = h.auth.password
        ...
        l.open(h.method.toUpperCase(), r(b, h.params, h.paramsSerializer), !0),
          (l.timeout = h.timeout);
        function U() {
          if (!!l) {
            var x =
        ...
        if (
          ...
          (l.onabort = function () {
            !l ||
              (S(new g("Request aborted", g.ECONNABORTED, h, l)), (l = null));
          }),
          (l.onerror = function () {
          ...
          (l.ontimeout = function () {
            var N = h.timeout
                ...
                : "timeout exceeded",
              F = h.transitional || c;
            h.timeoutErrorMessage && (N = h.timeoutErrorMessage),
              S(
                new g(
                  N,
          ...
          var R =
            (h.withCredentials || o(b)) && h.xsrfCookieName
              ? n.read(h.xsrfCookieName)
              : void 0;
          R && (m[h.xsrfHeaderName] = R);
        }
        "setRequestHeader" in l &&
          e.forEach(m, function (N, F) {
            typeof A > "u" && F.toLowerCase() === "content-type"
              ? delete m[F]
              : l.setRequestHeader(F, N);
          }),
          e.isUndefined(h.withCredentials) ||
            (l.withCredentials = !!h.withCredentials),
          i && i !== "json" && (l.responseType = h.responseType),
          typeof h.onDownloadProgress == "function" &&
            l.addEventListener("progress", h.onDownloadProgress),
          typeof h.onUploadProgress == "function" &&
            l.upload &&
            l.upload.addEventListener("progress", h.onUploadProgress),
          (h.cancelToken || h.signal) &&
            ((p = function (x) {
              !l ||
                (S(!x || (x && x.type) ? new f() : x), l.abort(), (l = null));
            }),
            h.cancelToken && h.cancelToken.subscribe(p),
            h.signal &&
              (h.signal.aborted ? p() : h.signal.addEventListener("abort", p))),
          A || (A = null);
        var E = d(b);
...
var ue = {
  ...
  transformRequest: [
    function (t, n) {
      ...
      if ($.isURLSearchParams(t))
        return (
          tt(n, "application/x-www-form-urlencoded;charset=utf-8"), t.toString()
        );
      var r = $.isObject(t),
        s = n && n["Content-Type"],
        a;
  ...
  transformResponse: [
    function (t) {
      var n = this.transitional || ue.transitional,
        ...
        try {
          ...
          if (a)
            throw o.name === "SyntaxError"
              ? et.from(o, et.ERR_BAD_RESPONSE, this, null, this.response)
              : o;
        }
      return t;
    },
...
var dr = function (t) {
    Se(t),
      (t.headers = t.headers || {}),
      (t.data = Pe.call(t, t.data, t.headers, t.transformRequest)),
      (t.headers = rt.merge(
        t.headers.common || {},
        t.headers[t.method] || {},
        t.headers
    ...
    return n(t).then(
      function (s) {
        return (
          Se(t),
          (s.data = Pe.call(t, s.data, s.headers, t.transformResponse)),
          s
        );
      },
      function (s) {
  ...
  $t = function (t, n) {
    ...
    var r = {};
    function s(d, y) {
      return q.isPlainObject(d) && q.isPlainObject(y)
        ? q.merge(d, y)
        : q.isPlainObject(y)
        ? q.merge({}, y)
        : q.isArray(y)
    ...
    function a(d) {
      if (q.isUndefined(n[d])) {
        if (!q.isUndefined(t[d])) return s(void 0, t[d]);
      } else return s(t[d], n[d]);
    }
    function o(d) {
      if (!q.isUndefined(n[d])) return s(void 0, n[d]);
    }
    function c(d) {
      if (q.isUndefined(n[d])) {
        if (!q.isUndefined(t[d])) return s(void 0, t[d]);
      } else return s(void 0, n[d]);
    }
    function g(d) {
      if (d in n) return s(t[d], n[d]);
      if (d in t) return s(void 0, t[d]);
    }
    var f = {
      url: o,
      method: o,
    ...
    return (
      q.forEach(Object.keys(t).concat(Object.keys(n)), function (y) {
        var h = f[y] || a,
          w = h(y);
...
Z.prototype.request = function (t, n) {
  ...
  if (!a) {
    var g = [it, void 0];
    for (
      Array.prototype.unshift.apply(g, s),
        g = g.concat(o),
        c = Promise.resolve(n);
      g.length;
  ...
  for (; o.length; ) c = c.then(o.shift(), o.shift());
  return c;
};
  ...
  function t(n) {
    ...
    this.promise.then(function (a) {
      if (!!s._listeners) {
        ...
        for (o = 0; o < c; o++) s._listeners[o](a);
        s._listeners = null;
      }
    }),
      (this.promise.then = function (a) {
...
function Mt(e) {
  var t = new re(e),
    n = Er(re.prototype.request, t);
  return (
    dt.extend(n, re.prototype, t),
    dt.extend(n, t),
    (n.create = function (s) {
      return Mt(Pr(e, s));
    }),
...
var xr = function (e) {
  ...
  Tr = function (e, t) {
    for (
      var n = {}, r = Object.keys(e), s = Array.isArray(t), a = 0;
      a < r.length;
      a++
    ) {
      var o = r[a],
...
(function (e) {
        ...
        return (u) => (l, C) =>
          ...
          (i.skipEmptyString && C === "")
            ...
            : ((C = C === null ? "" : C),
              l.length === 0
                ? [[d(u, i), p, d(C, i)].join("")]
                : [[l, d(C, i)].join(i.arrayFormatSeparator)]);
      }
      default:
        return (p) => (u, l) =>
          l === void 0 ||
  ...
  function g(i) {
    ...
    switch (i.arrayFormat) {
      ...
      case "separator":
        return (u, l, C) => {
          const I = typeof l == "string" && l.includes(i.arrayFormatSeparator),
            b =
              typeof l == "string" &&
              !I &&
              y(l, i).includes(i.arrayFormatSeparator);
          l = b ? y(l, i) : l;
          const U =
            I || b
              ? l.split(i.arrayFormatSeparator).map((R) => y(R, i))
              : l === null
              ? l
              : y(l, i);
          C[u] = U;
      ...
      case "bracket-separator":
        return (u, l, C) => {
          ...
          const b =
            l === null
              ? []
              : l.split(i.arrayFormatSeparator).map((U) => y(U, i));
          if (C[u] === void 0) {
            C[u] = b;
            return;
          }
  ...
  function m(i, p) {
    ...
    for (const C of i.split("&")) {
      ...
      (b =
        b === void 0
          ? null
          : ["comma", "separator", "bracket-separator"].includes(p.arrayFormat)
          ? b
          : y(b, p)),
        u(y(I, p), b, l);
    }
    for (const C of Object.keys(l)) {
      ...
      if (typeof I == "object" && I !== null)
        for (const b of Object.keys(I)) I[b] = A(I[b], p);
      else l[C] = A(I, p);
    }
    return p.sort === !1
      ? l
  ...
  (e.extract = S),
    ...
    (e.stringify = (i, p) => {
      ...
      (p = Object.assign(
        ...
        f(p.arrayFormatSeparator);
      const u = (b) =>
          (p.skipNull && a(i[b])) || (p.skipEmptyString && i[b] === ""),
        l = c(p),
        C = {};
      for (const b of Object.keys(i)) u(b) || (C[b] = i[b]);
      const I = Object.keys(C);
      return (
        p.sort !== !1 && I.sort(p.sort),
        I.map((b) => {
          const U = i[b];
          return U === void 0
            ? ""
            ...
            ? d(b, p)
            : Array.isArray(U)
            ? U.length === 0 && p.arrayFormat === "bracket-separator"
              ? d(b, p) + "[]"
              : U.reduce(l(b), []).join("&")
            : d(b, p) + "=" + d(U, p);
        })
    ...
    (e.parseUrl = (i, p) => {
      ...
      return Object.assign(
        ...
        p && p.parseFragmentIdentifier && l
          ? { fragmentIdentifier: y(l, p) }
          : {}
      );
    }),
    (e.stringifyUrl = (i, p) => {
      ...
      const u = w(i.url).split("?")[0] || "",
        l = e.extract(i.url),
        C = e.parse(l, { sort: !1 }),
        I = Object.assign(C, i.query);
      let b = e.stringify(I, p);
      b && (b = `?${b}`);
      let U = O(i.url);
      return (
        i.fragmentIdentifier &&
          (U = `#${p[o] ? d(i.fragmentIdentifier, p) : i.fragmentIdentifier}`),
        `${u}${b}${U}`
      );
    }),
    (e.pick = (i, p, u) => {
...
const Fr = (e) => !!((e != 408 && e.toString().startsWith("4")) || e == 500),
  Nr = (e) => (e.response && e.response.status) || kr(e.message),
  kr = (e) =>
    typeof e == "string" && e.startsWith("timeout of")
      ? 408
      : typeof e == "string" && e.startsWith("Network Error")
      ? 0
      : 500,
  Ur = (e) => {
    var t, n;
...
function jt(e) {
  return (
    e.data["sw-context-token"] ||
    e.data.contextToken ||
    e.headers["sw-context-token"]
  );
}
function Dr(e) {
  return function (t) {
...
function Hr(e = {}) {
  ...
  const r = Ar.create();
  function s() {
    (r.defaults.baseURL = n.endpoint),
      n.timeout &&
        (r.defaults.timeout =
          (typeof n.timeout == "number" && n.timeout) ||
          (typeof n.timeout == "string" && parseInt(n.timeout)) ||
          0),
      (r.defaults.headers.common["sw-include-seo-urls"] = "true"),
      (r.defaults.headers.common["sw-access-key"] = n.accessToken),
      (r.defaults.paramsSerializer = Wr),
      n.contextToken
        ? (r.defaults.headers.common["sw-context-token"] = n.contextToken)
        : delete r.defaults.headers.common["sw-context-token"],
      n.languageId
        ? (r.defaults.headers.common["sw-language-id"] = n.languageId)
        : delete r.defaults.headers.common["sw-language-id"];
  }
  function a(f) {
    t.push(f);
  }
  ...
  return (
    r.interceptors.response.use(Dr(c), _r),
    {
      onConfigChange: a,
      config: n,
      setup: o,
...
const P = Vr(),
  Jr = () => "/store-api/category",
  zr = (e) => `/store-api/category/${e}`,
  Gr = (e) => `/store-api/landing-page/${e}`,
  Yr = (e) => `/store-api/product-listing/${e}`,
  Wt = () => "/store-api/product",
  ae = (e) => `/store-api/product/${e}`,
  Qr = (e) => `/store-api/product/${e}/reviews`,
  Xr = () => "/store-api/search",
  Zr = () => "/store-api/account/address",
  Le = (e) =>
    e ? `/store-api/account/address/${e}` : "/store-api/account/list-address",
  Ht = (e, t) => `/store-api/account/address/default-${e}/${t}`,
  Kr = (e) => Ht("billing", e),
  es = (e) => Ht("shipping", e),
  ts = () => "/store-api/account/customer",
  ns = () => "/store-api/account/register",
  rs = () => "/store-api/account/change-profile",
  ss = () => "/store-api/account/login",
  as = () => "/store-api/account/logout",
  Vt = () => "/store-api/order",
  os = () => "/store-api/account/change-email",
  is = () => "/store-api/account/change-password",
  us = () => "/store-api/account/recovery-password",
  cs = (e) => `/store-api/account/change-payment-method/${e}`,
  ls = () => "/store-api/checkout/cart",
  le = () => "/store-api/checkout/cart/line-item",
  ds = () => "/store-api/checkout/order",
  fs = () => "/store-api/order/state/cancel",
  ps = () => "/store-api/order/payment",
  Jt = () => "/store-api/context",
  zt = () => "/store-api/country",
  hs = () => "/store-api/payment-method",
  vs = () => "/store-api/shipping-method",
  Gt = () => "/store-api/salutation",
  gs = () => "/store-api/account/newsletter-recipient",
  ms = () => "/store-api/seo-url",
  ys = (e, t) => `/store-api/navigation/${e}/${t}`,
  ws = () => "/store-api/handle-payment",
  Cs = () => "/store-api/newsletter/subscribe",
  Es = () => "/store-api/newsletter/unsubscribe",
  Ps = () => "/store-api/customer/wishlist",
  Ss = (e) => `/store-api/customer/wishlist/add/${e}`,
  As = (e) => `/store-api/customer/wishlist/delete/${e}`,
  bs = () => "/store-api/customer/wishlist/merge";
async function Os(e, t = P) {
  return (await t.invoke.post(Jr(), e)).data;
}
async function Rs(e, t = P) {
  return (
    await t.invoke.post(`${Wt()}`, {
      ...(e || {}),
    })
  ).data;
}
async function xs(e, t, n = P) {
  return (await n.invoke.post(`${Yr(e)}`, t)).data;
}
async function Yt(e, t = null, n = P) {
  return (await n.invoke.post(ae(e), t)).data;
}
async function Is(e, t, n = P) {
  await n.invoke.post(`${ae(e)}/review`, t);
}
async function Ts(e, t, n = P) {
  return (
    await n.invoke.post(`${Qr(e)}`, {
      ...(t || {}),
    })
  ).data;
}
async function Fs(e, t = P) {
  return (await t.invoke.post(ns(), e)).data;
}
...
async function Us(e = {}, t = P) {
  try {
    return (await t.invoke.post(ts(), e)).data;
  } catch (n) {
    const r = n;
    if (r.statusCode === 403) return null;
    throw new Error("Unexpected getCustomerResponse. " + r);
  }
}
async function $s(e = {}, t = P) {
  return (await t.invoke.post(Le(), e)).data;
}
async function _s(e = {}, t = P) {
  return (await t.invoke.post(Vt(), e)).data.orders;
}
async function Ds(e, t = P) {
  return (await t.invoke.post(Zr(), e)).data;
}
async function qs(e, t = P) {
  return (await t.invoke.patch(Le(e.id), e)).data;
}
async function Ms(e, t = P) {
  await t.invoke.delete(Le(e));
}
async function Ls(e, t = P) {
  return (await t.invoke.patch(Kr(e))).data;
}
async function Bs(e, t = P) {
  return (await t.invoke.patch(es(e))).data;
}
async function js(e, t = P) {
  await t.invoke.post(os(), e);
}
async function Ws(e, t = P) {
  await t.invoke.post(is(), e);
}
async function Hs(e, t = P) {
  e && !e.storefrontUrl && (e.storefrontUrl = t.config.endpoint),
    await t.invoke.post(us(), e);
}
async function Vs(e, t = P) {
  await t.invoke.post(rs(), e);
}
async function Js(e, t = P) {
  return (await t.invoke.post(cs(e))).data;
}
async function zs(e = P) {
  return (await e.invoke.post(gs())).data;
}
...
async function Ks(e = P) {
  const { data: t } = await e.invoke.get(zt());
  return t;
}
...
async function aa(e, t = P) {
  var r;
  const { data: n } = await t.invoke.get(zt(), {
    params: {
      "filter[id]": e,
    },
  });
...
async function oa(e, t = P) {
  var r;
  const { data: n } = await t.invoke.get(Gt(), {
    params: {
      "filter[id]": e,
    },
  });
...
async function Qt(e, t = 1, n = P) {
  ...
  return (await n.invoke.patch(le(), r)).data;
}
async function Xt(e, t = P) {
  return (await t.invoke.delete(`${le()}?ids[]=${e}`)).data;
}
...
function de({ address: e, payload: t }, n = P) {
...
async function ha(e, t = P) {
  return (await t.invoke.post(ds(), e)).data;
}
async function Zt(e, t = P) {
  ...
  return (
    navigator != null &&
      ...
      sessionStorage.setItem("sw-context-token", t.config.contextToken),
    (
...
async function ya(e, t = P) {
  await t.invoke.post(Cs(), Object.assign({}, { option: "subscribe" }, e));
}
async function wa(e, t = P) {
  await t.invoke.post(Es(), e);
}
async function Ca(e, t = P) {
  return (await t.invoke.post(Ss(e))).data;
}
async function Ea(e, t = P) {
  return (await t.invoke.post(Ps(), e)).data;
}
async function Pa(e, t = P) {
  return (await t.invoke.delete(As(e))).data;
}
async function Sa(e, t = P) {
  return (await t.invoke.post(bs(), { productIds: e })).data;
}
P.config;
P.setup;
P.update;
...
function Aa(e) {
  return (
    (e == null ? void 0 : e.apiAlias) === "product" ||
    (e == null ? void 0 : e.type) === "product"
  );
}
function ba(e) {
  var t, n, r;
  return (
    (Aa(e) &&
      (((n = (t = e == null ? void 0 : e.cover) == null ? void 0 : t.media) ==
      null
        ? void 0
        : n.url) ||
        ((r = e == null ? void 0 : e.cover) == null ? void 0 : r.url))) ||
    ""
  );
}
function Y(e, t) {
...
function ht(e) {
  var n;
  if (!e || !((n = e.calculatedPrices) != null && n.length)) return [];
...
function gt(e) {
  ...
  for (const [n, r] of Object.entries(e))
    if (n === "properties" && Ra(r))
      for (const s of r.entities) t.push(vt(n, s));
    else ["properties", "options"].includes(n) || t.push(vt(n, r));
  return t;
}
function ja() {
  var d, y;
  const { apiInstance: e } = k(),
    { configurator: t, product: n } = Ua();
  if (!n.value)
    throw new Error(
      "Product configurator cannot be used without the product context."
    );
  const r = T({}),
    s = T(!!((d = n.value.options) != null && d.length)),
    a = v(() => {
      var h;
    ...
    c = (h) => {
      const w = o.value.find((O) => {
        var A;
        return !!((A = O.options) == null ? void 0 : A.find((m) => m.id === h));
      });
      return Y(w, "name");
    };
  return (
    (y = n.value.optionIds) == null ||
      y.forEach((h) => {
        const w = c(h);
        w && (r.value[w] = h);
      }),
    {
      ...
      findVariantForSelectedOptions: async (h) => {
        ...
        try {
          ...
          return (S =
            (O = A == null ? void 0 : A.data) == null ? void 0 : O.elements) ==
            null
            ? void 0
            : S[0];
        } catch (A) {
...
function Wa(e) {
  const { apiInstance: t } = k(),
    n = T([]),
    r = async (a = {}) => {
      var c;
      const o = await Ts(e.value.id, void 0, t);
    ...
    o = async (c) => {
      ...
      try {
        if (g && g === "get") {
          const d = await da(
            {
              address: `${ae(e.value.id)}/${n}${c.searchParams || ""}`,
            },
            r
          );
        ...
        console.error("[useProductAssociations][loadAssociations][error]:", f);
      } finally {
        s.value = !1;
      }
    };
...
function Ja(e) {
  function t(n) {
    return e.blocks.filter((r) => r.sectionPosition === n);
  }
  return {
    section: e,
...
function za(e) {
  const t = (e == null ? void 0 : e.type) || "main-navigation",
    { apiInstance: n } = k(),
    r = M(`swNavigation-${t}`, T([]));
  L(`swNavigation-${t}`, r);
  const s = v(() => r.value);
  async function a({ depth: o }) {
    try {
      ...
      return (
        (r.value = []),
        console.error("[useNavigation][loadNavigationElements]", c),
        []
      );
    }
  }
...
function fe() {
  ...
  async function r(m) {
    const i = await ua(m.id, m.quantity, e);
    return (t.value = i), i;
  }
  async function s(m) {
  ...
  async function a(m) {
    const i = await Qt(m.id, m.quantity, e);
    t.value = i;
  }
  async function o(m) {
    if (m) {
  ...
  const g = v(() => d.value.filter((m) => m.type === "promotion")),
    f = v(() => t.value),
    d = v(() => (f.value ? f.value.lineItems || [] : [])),
    y = v(() =>
      d.value.reduce((m, i) => (i.type === "product" ? i.quantity + m : m), 0)
    ),
    h = v(() => y.value <= 0),
    w = v(() => (f.value && f.value.price && f.value.price.totalPrice) || 0),
    O = v(() => {
      var i, p, u, l;
      return (
        ((l =
          (u =
            (p = (i = f.value) == null ? void 0 : i.deliveries) == null
              ? void 0
              : p[0]) == null
            ? void 0
            : u.shippingCosts) == null
          ? void 0
          : l.totalPrice) || 0
      );
    }),
    S = v(() => {
      var i, p;
      return (
        ((p = (i = f.value) == null ? void 0 : i.price) == null
          ? void 0
          : p.positionPrice) || 0
      );
    }),
    A = v(() => {
      var m;
      return (
        (((m = f.value) == null ? void 0 : m.errors) &&
          Object.values(f.value.errors)) ||
        []
      );
    });
  return {
...
function Ga(e) {
  ...
  const { apiInstance: t } = k(),
    ...
    o = v(() => {
      var S;
      return (
        ((S = e.price) == null ? void 0 : S.listPrice) && e.price.unitPrice
      );
    }),
    c = v(() => {
      var S;
      return (
        (e.type === "product" &&
          ((S = e.payload) == null ? void 0 : S.options)) ||
        []
      );
    }),
    g = v(() => {
  ...
  async function O() {
    if (!!e.referencedId)
      try {
        return (await Yt(e.referencedId, {}, t)).product;
      } catch (S) {
        console.error("[useCart][getProductItemsSeoUrlsData]", S.messages);
      }
  }
  return {
...
xa &&
  ((mt = window == null ? void 0 : window.navigator) == null
    ? void 0
    : mt.userAgent) &&
  /iP(ad|hone|od)/.test(window.navigator.userAgent);
function Ia(e, t, n = {}) {
  const { flush: r = "sync", deep: s = !1, immediate: a = !0 } = n;
  return (
    Array.isArray(t) || (t = [t]),
    sn(e, (o) => t.forEach((c) => (c.value = o)), {
      flush: r,
      deep: s,
      immediate: a,
    })
...
function je() {
  const { apiInstance: e } = k(),
    { userFromContext: t, refreshSessionContext: n } = en(),
    r = Q("customer");
  Ia(t, r, {
    immediate: !0,
  });
  const { getStorefrontUrl: s } = rn(),
    { refreshCart: a } = fe(),
    o = v(() => {
      var R, E;
      return (
        ((E = (R = y.value) == null ? void 0 : R.defaultPaymentMethod) == null
          ? void 0
          : E.translated) || null
      );
    }),
    ...
    g = v(() => {
      var R;
      return (
        ((R = y.value) == null ? void 0 : R.defaultShippingAddress) || null
      );
    }),
    f = T(null),
    d = T(null),
    y = v(() => r.value);
  async function h({ username: R, password: E } = {}) {
    await Ns({ username: R, password: E }, e), await n(), a();
  }
  async function w(R) {
    const E = await Fs({ ...R, storefrontUrl: s() }, e);
  ...
  async function S(R = {}) {
    try {
      const E = await Us(Object.assign({}, R), e);
      r.value = E;
    } catch (E) {
  ...
  const l = v(() => {
      var R;
      return (
        ((R = y.value) == null ? void 0 : R.defaultBillingAddressId) || null
      );
    }),
    C = v(() => {
      var R;
      return (
        ((R = y.value) == null ? void 0 : R.defaultShippingAddressId) || null
      );
    }),
    I = v(() => {
      var R;
...
function en(e) {
  const { apiInstance: t } = k(),
    ...
    w = v(() => {
      var u, l;
      return (
        ((l = (u = s.value) == null ? void 0 : u.customer) == null
          ? void 0
          : l.activeShippingAddress) || null
      );
    }),
    O = async (u) => {
      if (!(u != null && u.id))
    ...
    m = v(() => {
      var u, l;
      return (l = (u = s.value) == null ? void 0 : u.salesChannel) == null
        ? void 0
        : l.countryId;
    }),
    i = v(() => {
      var u, l;
      return (l = (u = s.value) == null ? void 0 : u.context) == null
        ? void 0
        : l.taxState;
    }),
    p = v(() => {
...
function Ya(e) {
  const t = v(() => Ie(e)),
    { addProduct: n, cartItems: r, refreshCart: s } = fe(),
    a = T(1);
  async function o() {
    a.value || (a.value = 1);
    const d = await n({
...
function Qa() {
  const e = M("swNotifications", T([]));
  L("swNotifications", e);
  function t(a) {
    var o;
    e.value =
      ((o = e.value) == null ? void 0 : o.filter(({ id: c }) => c !== a)) || [];
  }
  function n() {
    e.value = [];
  }
...
function te(e, ...t) {
  ...
  if (xe(e) && xe(n))
    for (const r in n)
      xe(n[r])
        ? (e[r] || Object.assign(e, { [r]: {} }), te(e[r], n[r]))
        : Object.assign(e, { [r]: n[r] });
  return te(e, ...t);
}
function Na(e) {
  var s;
  const t = (e == null ? void 0 : e.listingType) || "categoryListing",
    { apiInstance: n } = k();
  let r;
  if (t === "productSearchListing") r = async (a) => ma(a, n);
  else {
    const { category: a } = gn(),
      o =
        ((s = a.value) == null ? void 0 : s.id) ||
        (e == null ? void 0 : e.categoryId);
    r = async (c) => {
      if (!o)
        throw new Error(
...
function ka({ searchMethod: e, searchDefaults: t, listingKey: n }) {
  const r = T(!1),
    s = T(!1),
    a = M(`useListingInitial-${n}`, T());
  ...
  const c = v(() => a.value),
    g = async (E) => {
      ...
      if (
        ((N =
          (x = E == null ? void 0 : E.currentFilters) == null
            ? void 0
            : x.manufacturer) == null
          ? void 0
          : N.length) ||
        ((j =
          (F = E == null ? void 0 : E.currentFilters) == null
            ? void 0
            : F.properties) == null
          ? void 0
          : j.length)
  ...
  const y = async () => {
    ...
    S = v(() => {
      var E;
      return (
        ((E = h.value) == null ? void 0 : E.limit) ||
        (t == null ? void 0 : t.limit) ||
        10
      );
    }),
    A = v(() => Math.ceil(O.value / S.value)),
    m = v(() => {
      var x, N;
      const E = Object.values(
        ((x = h.value) == null ? void 0 : x.sortings) || {}
      );
  ...
  const u = v(() => {
    ...
    I = v(() => {
      var E, x;
      return gt(
        ((E = o.value) == null ? void 0 : E.aggregations) ||
          ((x = h.value) == null ? void 0 : x.aggregations)
      );
    }),
    b = v(() => {
      var N;
      ...
      return (
        Object.keys(x).forEach((F) => {
          if (!!x[F] && F !== "navigationId") {
            if (F === "price") {
              x[F].min && (E["min-price"] = x[F].min),
                x[F].max && (E["max-price"] = x[F].max);
              return;
            }
            F !== "p" && (E[F] = x[F]);
          }
...
function Ua(e, t) {
  ...
  if (!n.value) throw new Error("Product context is not provided");
...
function Ka() {
  ...
  const O = v(() => {
      var A, m;
      return (m = (A = n.value) == null ? void 0 : A.shippingLocation) == null
        ? void 0
        : m.address;
    }),
    S = v(() => {
      var A, m;
      return (m = (A = n.value) == null ? void 0 : A.customer) == null
        ? void 0
        : m.activeBillingAddress;
    });
  return {
    getPaymentMethods: h,
    paymentMethods: d,
...
function no(e) {
  const { apiInstance: t } = k(),
    n = M("swOrderDetails", T());
  L("swOrderDetails", n);
  const r = v(() => {
      var m, i, p;
      return (p =
        (i = (m = n.value) == null ? void 0 : m.transactions) == null
          ? void 0
          : i[0]) == null
        ? void 0
        : p.paymentMethod;
    ...
    s = v(() => {
      var m, i, p;
      return (p =
        (i = (m = n.value) == null ? void 0 : m.deliveries) == null
          ? void 0
          : i[0]) == null
        ? void 0
        : p.shippingMethod;
    ...
    o = v(() => {
      ...
      return {
        email:
          (i = (m = n.value) == null ? void 0 : m.orderCustomer) == null
            ? void 0
            : i.email,
        firstName:
          (u = (p = n.value) == null ? void 0 : p.orderCustomer) == null
            ? void 0
            : u.firstName,
        lastName:
          (C = (l = n.value) == null ? void 0 : l.orderCustomer) == null
            ? void 0
            : C.lastName,
      };
    }),
    c = v(() => {
      var m, i;
      return (i = (m = n.value) == null ? void 0 : m.addresses) == null
        ? void 0
        : i.find(({ id: p }) => p === n.value.billingAddressId);
    }),
    g = v(() => {
      var m, i, p;
      return (p =
    ...
    d = v(() => {
      var m, i;
      return (i = (m = n.value) == null ? void 0 : m.price) == null
        ? void 0
        : i.positionPrice;
    }),
    y = v(() => {
    ...
    h = v(() => {
      var m, i;
      return (i = (m = n.value) == null ? void 0 : m.stateMachineState) == null
        ? void 0
        : i.name;
    });
  async function w() {
    const m = await va(e, $a, t);
...
function ro(e) {
  const { apiInstance: t } = k(),
    n = v(() => {
      var f, d;
      return (d = (f = e.value) == null ? void 0 : f.transactions) == null
        ? void 0
        : d.find((y) => {
            var h;
    ...
    o = v(() => {
      var f, d, y, h;
      return (
        ((d = (f = n.value) == null ? void 0 : f.paymentMethod) == null
          ? void 0
          : d.asynchronous) &&
        ((h = (y = n.value) == null ? void 0 : y.paymentMethod) == null
          ? void 0
          : h.afterOrderEnabled)
      );
    });
...
function tn() {
  const e = () => {
      localStorage.setItem("sw-wishlist-items", JSON.stringify(W.value));
    },
    t = () => {
      var g;
      if (typeof window < "u" && localStorage)
        return JSON.parse(
          (g = localStorage.getItem("sw-wishlist-items")) != null ? g : "[]"
        );
    };
  async function n(g) {
    var f;
    (W.value = (f = W.value) == null ? void 0 : f.filter((d) => d != g)), e();
  }
  async function r(g) {
...
function nn() {
  ...
  async function r() {
    ...
    Ct.value = [...c.products.elements.map((g) => g.id)];
  }
  async function s(c) {
    await Sa(c, e);
  }
...
function io(e, t) {
  const n = an(!0),
    ...
    s = on({
      install(a, o) {
        (s._a = a),
          (a.config.globalProperties.$shopware = s),
          a.provide("shopware", s),
          o != null && o.enableDevtools && typeof window < "u";
      },
      _a: e,
      _e: n,
...
function co(e) {
  const t = v(() => {
    ...
    n = v(() => {
      var w, O, S, A;
      return ((O = (w = e.value) == null ? void 0 : w.calculatedPrices) == null
        ? void 0
        : O.length) > 0
        ? (S = e.value) == null
          ? void 0
          : S.calculatedPrices[0]
        : (A = e.value) == null
        ? void 0
        : A.calculatedPrice;
    }),
    r = v(() => {
      var w;
      return (w = n == null ? void 0 : n.value) == null
        ? void 0
        : w.referencePrice;
    }),
    s = v(() => {
      var w, O, S;
      return (
        ((O = (w = e.value) == null ? void 0 : w.variantListingConfig) == null
          ? void 0
          : O.displayParent) &&
        ((S = e.value) == null ? void 0 : S.parentId) === null
      );
    }),
    a = v(() => {
      var w, O;
      return (
        ((O = (w = e.value) == null ? void 0 : w.calculatedPrices) == null
          ? void 0
          : O.length) > 1 || !!(s.value && o.value)
      );
    }),
    o = v(() => {
      var w, O, S, A, m, i, p;
      return (
        !!e.value.parentId &&
        ((O = (w = e.value) == null ? void 0 : w.cheapestPrice) == null
          ? void 0
          : O.hasRange) &&
        !!(
          (A = (S = e.value) == null ? void 0 : S.cheapestPrice) != null &&
          A.parentId
        ) &&
        ((m = n == null ? void 0 : n.value) == null ? void 0 : m.unitPrice) !==
          ((i = t == null ? void 0 : t.value) == null ? void 0 : i.unitPrice) &&
        ((p = t == null ? void 0 : t.value) == null ? void 0 : p.unitPrice)
      );
    }),
    c = v(() => {
      var w;
      return a.value && ht(e.value).length > 1
        ? ((w = e.value) == null
            ? void 0
            : w.calculatedPrices.reduce((S, A) =>
                A.unitPrice < S.unitPrice ? A : S
              )) || t.value
        : n.value;
    }),
    g = v(() => {
    ...
    y = v(() => {
      var w, O;
      return !!(
        (O = (w = c.value) == null ? void 0 : w.listPrice) != null &&
        O.percentage
      );
    }),
    h = v(() => ht(e.value));
...
function lo(e) {
  const t = Oa(e),
    n = v(() => {
      let r = [];
      const s = Y(t, "keywords"),
        a = Y(t, "metaDescription"),
        o = Y(t, "metaTitle");
      return (
        s && r.push({ name: "keywords", content: s }),
        a && r.push({ name: "description", content: a }),
        o && r.push({ name: "title", content: o }),
        r
      );
    });
  return {
...
function po(e) {
  const t = Q("navigation", { context: e }),
    n = v(() => {
      var s;
...
function vo() {
  const { isLoggedIn: e, isGuestSession: t } = je(),
    n = v(() => e.value && !t.value),
    { getWishlistProducts: r, items: s, clearWishlist: a } = tn(),
    { getWishlistProducts: o, items: c, mergeWishlistProducts: g } = nn(),
    f = async () => {
...
function go(e) {
  const { isLoggedIn: t } = je(),
    { addToWishlist: n, removeFromWishlist: r, items: s } = tn(),
    { addToWishlistSync: a, removeFromWishlistSync: o, items: c } = nn();
  async function g() {
  ...
  const d = v(() => {
    ...
    return t.value
      ? (y = c.value) == null
        ? void 0
        : y.includes(e.value.id)
      : (h = s.value) == null
      ? void 0
      : h.includes(e.value.id);
  });
  return {
    addToWishlist: f,
...
function mo(e) {
  const t = e.type,
    n =
      e.apiAlias === "cms_block"
        ? "Block"
        : e.apiAlias === "cms_section"
        ? "Section"
        : "Element",
    r = hn(`Cms-${n}-${t}`);
  try {
